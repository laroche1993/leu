...
export default function Lawyer({ navigation }: any) {
  ...
  const findLawyer = () => {
    ...
    const html = `<body class='body' style='padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#ffffff; -webkit-text-size-adjust:none;'>
                ...
                <tr>
                  <td class='td' style='width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;'>
                    ...
                    <div mc:repeatable='Select' mc:variant='Hero'>
                      <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                        <tr>
                          <td class='fluid-img' style='font-size:0pt; line-height:0pt; text-align:left;'><img src='${img1}' width='650' height='366' mc:edit='image_2' style='max-width:650px;' border='0' alt='' /></td>
                        </tr>
                        <tr>
                          <td class='p30-15' style='padding: 40px 0px 40px 0px;'>
                            <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                              <tr>
                                <td class='h3 pb15' style='color:#000000; font-family:Arial, sans-serif; font-size:22px; line-height:32px; text-align:left; padding-bottom:15px;'><div mc:edit='text_2'>Solicitud de consulta de abogado</div></td>
                              </tr>
                              <tr>
                                <td class='text pb15' style='color:#666666; font-family:Arial, sans-serif; font-size:15px; line-height:28px; text-align:left; padding-bottom:15px;'><div mc:edit='text_3'>Se ha realiado una nueva solicitud de consultoría de abogado por parte del usuario ${data.name} ${data.lastName} con la siguiente información.</div></td>
                              </tr>
                              <tr>
                                ...
                                <h7><span style='font-weight: bold'>Email:</span> ${data.email}</h7><br>
                                <h7><span style='font-weight: bold'>Tipo:</span> ${data.type}</h7><br>
                                <h7><span style='font-weight: bold'>Ciudad:</span> ${data.city}</h7><br>
                                <h7><span style='font-weight: bold'>Área:</span> ${data.area}</h7><br>
                              </tr>
                            </table>
                          </td>
                        </tr>
    ...
    if (isValid) {
      ...
      axios
        .post(
          ...
          {
            subject: "Solicitud de consulta de abogado.",
            from: data.email,
            ...
            <View style={{ marginHorizontal: SIZES.xl }}>
              ...
              <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View>
                  ...
                  <View>
                    <Input
                      onChangeText={(e) => handleData("type", e)}
                      value={data.type}
                      label={i18n.t("type")}
                      placeholderTextColor={COLORS.gray}
                      style={{
